...
//
// Shown by App Router while microgrids/[id]/page.tsx (5+ Supabase queries +
// OpenEMS status/energy calls) resolves — on both client navigations and hard
// loads. Mirrors the page's own layout (breadcrumb row, edge-health card,
// open-period strip, leaderboard + calendar grid, activity log) with
// token-only skeleton blocks so the frame doesn't jump when content lands.
//
